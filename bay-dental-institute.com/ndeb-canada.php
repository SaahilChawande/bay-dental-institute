...
<head>
    ...
    <title>NDEB Canada - Bay Dental Institute</title>
    ...
    <div class="page_wrap">
                            ...
                            <ul id="menu_main" class="menu_main_nav">
                                ...
                                <li class="menu-item menu-item-has-children current-menu-ancestor"><a href="#"><span>Courses &nbsp;&#8659;</span></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item"><a href="javascript:void(0)"><span>NDEB - Canada</span></a></li>
        ...
        <div class="top_panel_title top_panel_style_2 title_present breadcrumbs_present scheme_original dark-background">
            <div class="top_panel_title_inner top_panel_inner_style_2 title_present_inner breadcrumbs_present_inner">
                <div class="content_wrap">
                    <h1 class="page_title">NDEB - Canada</h1>
                    <div class="breadcrumbs">
                        <a class="breadcrumbs_item home" href="index.php">Home</a>
                        <span class="breadcrumbs_delimiter"></span>
                        <span class="breadcrumbs_item current">NDEB - Canada</span>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper centext">
                                                    <p>
                                                        The National Dental Examining Board of Canada, also known as the NDEB is the organization is responsible for granting approval for dentists to practice in Canada through standardized examinations.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper centext">
                                                    ...
                                                    <p>The Written Examination consists of 2 papers, each with 150 multiple choice type questions. Each paper is given in a 2 hours and thirty minutes examination session.</p>
                                                    <p>The sessions are held in the morning and afternoon of one day.</p>
                                                    <p>One part of the written examination tests the basic sciences while the other tests the clinical sciences.</p>
                                                    <p>The basic sciences portion resembles Part I of the National Board Dental Examination in the United States, while the clinical portion is similar to Part II.</p>
                                                    <br>
                                                    <h3>Objective Structured Clinical Examination (OSCE)</h3>
                                                    <p>The OSCE is a station type examination (also known as "bell-ringer" type).</p>
                                                    <p>The majority of the stations have 2 questions and require the candidate to review the information supplied (e.g. case history, photographs, radiographs, casts, models) and answer extended match type questions. Each extended match type question has up to 15 answer options and one or more correct answer(s). A few stations may require the candidate to review the information supplied and write an acceptable prescription for a medication commonly prescribed by general dentists in Canada.</p>
                                                    <p>Candidates have 5 minutes at each station to answer the questions, after which they move on to the next station.</p>
                                                    <p>The dates of the current exam cycle are a Saturday and a Sunday in March, June and December. The examination is administered on two consecutive days; the written section on Saturday and the OSCE on Sunday. Accommodations can usually be made for candidates who have conflicting religious observations. For candidates who observe the Sabbath on Saturday, the written exam may be taken on Friday. The current fee for the exam is CDN $2800. Once graduation from an accredited dental school is confirmed, the NDEB sends successful candidates an official certificate, which in turn is used to apply to individual provinces and territories for licensure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
