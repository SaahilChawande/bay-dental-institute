                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <iframe class="margin_right_small margin_bottom_small margin_top_small" width="971" height="546" src="https://www.youtube.com/embed/FH9PnKRdXHY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <iframe class="margin_right_small margin_bottom_small margin_top_small" width="971" height="546" src="https://www.youtube.com/embed/VErl4b9wI1E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <iframe class="margin_right_small margin_bottom_small margin_top_small" width="971" height="546" src="https://www.youtube.com/embed/nCzp9Nbxqas" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <iframe class="margin_right_small margin_bottom_small margin_top_small" width="971" height="546" src="https://www.youtube.com/embed/o8_Ybtv2JLA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </section>
