                ...
                <div class="panel_top">
                    <nav class="menu_main_nav_area">
                        <ul id="menu_main_mobile" class="menu_main_nav">
                            <li class="menu-item current-menu-item" onclick="onClickHome()"><a href="index.php"><span>Home</span></a></li>
                            <!--<li class="menu-item" onclick="onClickAboutUsMenu()"><a href="javascript:void(0);">About Us</a></li>-->
                            <li class="menu-item"><a href="vision.php">Vision</a></li>
                            <li class="menu-item menu-item-has-children"><a href="index.php#about-us"><span>Courses</span></a>
